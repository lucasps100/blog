...
##CONNECT TO DB
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///finalblog.db'
...
@app.route("/about")
def about():
    return render_template("about.html", current_user=current_user, logged_in = current_user.is_authenticated)


@app.route("/contact")
def contact():
    return render_template("contact.html", current_user=current_user, logged_in = current_user.is_authenticated)
